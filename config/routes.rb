Tipsi::Application.routes.draw do
  ...
  match "taste/zinfandel" => "taste#zinfandel"
  match "taste/syrah" => "taste#syrah"
  match "taste/chianti" => "taste#chianti"
  match "taste/canaiolo-nero" => "taste#canaiolo_nero"
  match "taste/sangiovese" => "taste#sangiovese"
  match "taste/carignane" => "taste#carignane"
  match "taste/touriga-national" => "taste#touriga_national"
  match "taste/petit-verdot" => "taste#petit_verdot"
  match "taste/bonarda" => "taste#bonarda"    
  match "taste/colorino" => "taste#colorino"
  match "taste/claret" => "taste#claret"
  match "taste/meritage" => "taste#meritage"
  match "taste/cinsault" => "taste#cinsault"
  match "taste/barbera-d-alba" => "taste#barbera_d_alba"  
  match "taste/bical" => "taste#bical"
  match "taste/riesling" => "taste#riesling"
  match "taste/chablis" => "taste#chablis"
  match "taste/semillon" => "taste#semillon"
  match "taste/marsanne" => "taste#marsanne"
  match "taste/roussanne" => "taste#roussanne"
  match "taste/chenin-blanc" => "taste#chenin_blanc"
  match "taste/fume-blanc" => "taste#fume_blanc"
  match "taste/pinot-grigio" => "taste#pinot_grigio"
  match "taste/viognier" => "taste#viognier"
  match "taste/gruner-veltliner" => "taste#gruner_veltliner"
  match "taste/arneis" => "taste#arneis"
  match "taste/ribolla-gialla" => "taste#ribolla_gialla"
  match "taste/gewurztraminer" => "taste#gewurztraminer"
  match "taste/blushes" => "taste#blushes"
  match "taste/athiri" => "taste#athiri"
  match "taste/clairette" => "taste#clairette"
